...
struct FreeboxAPI {
    ...
    static let sessionToken = "8ZKbFGkQw2F4PF8DZkZ4lxl3TGwTPTlXAgcakKNacmhuIMvrNpmfCFWINhxqKdry" //This is a temp X-Fbx-App-Auth token, should be regenerated by Freebox to work
