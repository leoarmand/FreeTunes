...
struct FreeboxAPI {
    ...
    static let sessionToken = "MGwSSSj1C+SXZTWBObL3V0hZWNzyApo5vnrKMSiWT44fy28X1FMJfpw+qtWrdtUl" //This is a temp X-Fbx-App-Auth token, should be regenerated by Freebox to work
